...
```
--add-exclusive-node rveahdfho7wo4b2m.onion:39713
--add-peer rveahdfho7wo4b2m.onion:39713
```
...
```
--anonymous-inbound rveahdfho7wo4b2m.onion:39713,127.0.0.1:39713,25
--anonymous-inbound cmeua5767mz2q5jsaelk2rxhf67agrwuetaso5dzbenyzwlbkg2q.b32.i2p:5000,127.0.0.1:30000
```

which tells `sherkittyd` that a max of 25 inbound Tor connections are being
received at address "rveahdfho7wo4b2m.onion:39713" and forwarded to `sherkittyd`
localhost port 39713, and a default max I2P connections are being received at
...
must be the RPC port (typically 56981 for mainnet) instead of the p2p port:

```
HiddenServiceDir /var/lib/tor/data/sherkitty
HiddenServicePort 56981 127.0.0.1:56981
```
...
```
HiddenServiceDir /var/lib/tor/data/sherkitty
HiddenServicePort 39713 127.0.0.1:39713
```

This will store key information in `/var/lib/tor/data/sherkitty` and will forward
"Tor port" 39713 to port 39713 of ip 127.0.0.1. The file

...
gsigs = 'https://github.com/sherkitty-project/gitian.sigs.git'
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/sherkitty-project/sherkitty', help='Specify the URL of the repository. Default is %(default)s')

...
RUN	git clone https://github.com/sherkitty-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/sherkitty-project/sherkitty
...
if [ ! -d sigs ]; then
	git clone https://github.com/sherkitty-project/gitian.sigs.git sigs
	cd sigs
